      ...
      <div className="max-w-7xl mx-auto px-4 py-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-brand-card rounded-lg shadow-sm border border-slate-200 dark:border-slate-800 p-5 sticky top-24 hidden lg:block space-y-4">
              ...
              <nav className="flex flex-col gap-1 text-sm" aria-label="Profile sections">
                {SECTIONS.map((s) => (
                  <button
                    ...
                    className={`flex items-center w-full text-left px-3 py-2 rounded-lg font-medium transition-all min-h-[44px] focus-visible:outline-2 focus-visible:outline-brand-primary focus-visible:outline-offset-[-2px] ${
                      form.activeSection === s.id
                        ? 'text-brand-primary bg-brand-primary-light font-bold border-l-2 border-brand-primary'
