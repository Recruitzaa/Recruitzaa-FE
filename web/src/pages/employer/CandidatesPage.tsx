    ...
    <div className={styles.page}>
      ...
      <div className={styles.header}>
        <div>
          ...
          <p className={styles.subtitle}>Review and manage applicants across all your active job postings.</p>
        </div>
      </div>
          ...
          <table className={styles.table}>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><span className={styles.scoreText}>88% Match</span></td>
              ...
              <tr>
                <td>
                  <div className={styles.candidateProfile}>
                    <div className={styles.avatar} style={{backgroundColor: '#3B82F6'}}>DP</div>
                    <div>
                ...
                <td><span className={styles.subTextDark}>Senior React Native Developer</span></td>
                <td><span className={styles.scoreText}>82% Match</span></td>
                <td><Badge variant="primary">Interview</Badge></td>
                <td><span className={styles.subText}>Jul 5, 2025</span></td>
                <td>
                  <Button size="sm" variant="outline">Review Profile</Button>
                </td>
              </tr>
              <tr>
                <td>
                  <div className={styles.candidateProfile}>
                    <div className={styles.avatar} style={{backgroundColor: '#8B5CF6'}}>MJ</div>
                    <div>
                ...
                <td><span className={styles.subTextDark}>Backend Engineer (Node.js)</span></td>
                <td><span className={styles.scoreText}>97% Match</span></td>
                <td><Badge variant="success">Offer Extended</Badge></td>
                <td><span className={styles.subText}>Jun 28, 2025</span></td>
                <td>
                  <Button size="sm" variant="outline">Review Profile</Button>
                </td>
              </tr>
