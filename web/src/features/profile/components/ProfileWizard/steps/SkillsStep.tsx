      ...
      <div>
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 text-xs p-2.5 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 rounded outline-none focus:border-indigo-600 text-slate-900 dark:text-slate-100"
          />
          <button
            type="button"
            onClick={handleAdd}
            className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-xs px-4 py-2.5 rounded transition-all"
          >
            Add
          </button>
        </div>
      ...
      <div className="pt-2">
        ...
        <div className="flex flex-wrap gap-1.5 min-h-[50px] p-3 bg-slate-50 dark:bg-slate-900/50 rounded-lg border border-slate-200 dark:border-slate-800">
          {data.map((skill) => (
            <span
              key={skill}
              className="inline-flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1 rounded bg-indigo-50 dark:bg-indigo-950/30 text-indigo-600 dark:text-indigo-400 border border-indigo-200 dark:border-indigo-900/50"
            >
              {skill}
              <button
                type="button"
