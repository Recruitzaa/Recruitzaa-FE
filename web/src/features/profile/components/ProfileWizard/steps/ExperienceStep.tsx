    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3 p-3 bg-slate-50 dark:bg-slate-900/50 rounded-lg border border-slate-200 dark:border-slate-800">
        ...
        <textarea
          ...
          className="w-full text-xs p-2 border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 rounded outline-none text-slate-900 dark:text-slate-100 resize-none min-h-[50px]"
        />
        <Button
          onClick={handleAdd}
          type="button"
